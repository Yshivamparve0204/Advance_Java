...
import com.demo.SpringBootDemo.bean.Product;
import com.demo.SpringBootDemo.dao.ProductDao;
import com.demo.SpringBootDemo.dto.ProductDto;
import com.demo.SpringBootDemo.mapper.ProductDtoMapper;
@Service
public class ProductServiceImpl implements ProductService {
	...
	public ProductDto getById(int pid) {
		...
		if(op.isPresent()) {
			ProductDto prod= ProductDtoMapper.mapToProductDto(op.get());
			return prod;
		}
		return null;
	}
