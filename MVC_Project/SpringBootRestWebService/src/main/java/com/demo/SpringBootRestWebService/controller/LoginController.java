...
public class LoginController {
    ...
    public ResponseEntity<String> authenticateUser(@RequestBody MyUserDto myuserDto){
    	...
    	if(myuserDto.getUsername().equals("user1") && myuserDto.getPassword().equals("user123")) {
